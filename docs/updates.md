# Spark Update: Public Labs And May 10 Installer
...
- May 10 Spark CLI installer pin with hosted checksums, release manifest, command metadata, attestations, and production smoke checks.
...
```text
spark-cli-launch-2026-05-10
3860562fb76d035d25a46d5c6bee269b867463f3
```
