# Spark Update: Spark OS Registry And May 12 Installer
...
- May 12 Spark CLI installer pin with hosted checksums, release manifest, command metadata, attestations, and production smoke checks.
