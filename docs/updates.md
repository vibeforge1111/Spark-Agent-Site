# Spark Update: Spark OS Registry And May 13 Installer
...
- May 13 Spark CLI installer pin with hosted checksums, release manifest, command metadata, attestations, and production smoke checks.
...
```text
spark-cli-launch-2026-05-13-character-curated
52e1ca50c9a51fa8e5c0963f6bbebc25c8482852
```
