...
SPARK_CLI_RELEASE_NAME="${SPARK_CLI_RELEASE_NAME:-spark-cli-launch-2026-05-14-integrated-main-r1}"
SPARK_DEFAULT_CLI_REF="2a8b8765bc7b7d3233984a2b710091cc092b1756"
